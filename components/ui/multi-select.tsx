        ...
        <Popover
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex p-1 rounded-md border border-input min-h-9 h-auto items-center justify-between bg-transparent hover:bg-transparent dark:bg-input/30 dark:hover:bg-input/50 [&_svg]:pointer-events-auto",
              ...
              {selectedValues.length > 0 ? (
                ...
                <div className="flex items-center justify-between w-full mx-auto">
                  <span className="text-muted-foreground mx-2 font-normal text-base md:text-sm">
                    {placeholder}
                  </span>
                  <ChevronDown className="h-4 cursor-pointer text-muted-foreground opacity-50 mx-2" />
                </div>
              )}
            </Button>
          </PopoverTrigger>
          <PopoverContent
            ...
            <Command>
              ...
              <CommandList
                ...
                <CommandEmpty>
                  {emptyIndicator || "Hasil tidak ditemukan."}
                </CommandEmpty>{" "}
